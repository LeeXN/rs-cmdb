...
pub fn create_router(
    ...
    let public_routes = Router::new()
        ...
        .route("/api/v1/download/client/{platform}/{arch}/{binary_name}", get(download_api::download_client))
        .route("/install.sh", get(download_api::get_install_script))
        // Client registration (agent)
        .route("/api/v1/clients/register", post(client_api::register_client))
        // Hardware push (agent)
        .route("/api/v1/clients/{id}/hardware", post(hardware_api::update_hardware));

    // Admin routes
    let admin_routes = Router::new()
        .route("/api/v1/accounts", get(user_api::list_users))
        .route("/api/v1/accounts/{id}", delete(user_api::delete_user).put(user_api::update_user))
    ...
    let write_routes = Router::new()
        ...
        .route("/api/v1/clients/{id}", put(client_api::update_client).delete(client_api::delete_client))
        .route("/api/v1/users", post(person_api::create_person))
        .route("/api/v1/users/{id}", put(person_api::update_person).delete(person_api::delete_person))
        .route("/api/v1/projects", post(project_api::create_project))
        .route("/api/v1/projects/{id}", put(project_api::update_project).delete(project_api::delete_project))
        .route("/api/v1/components", post(component_api::create_component))
        .route("/api/v1/components/batch/create", post(component_api::batch_create_components))
        .route("/api/v1/components/batch/delete", post(component_api::batch_delete_components))
        .route("/api/v1/components/batch/update", post(component_api::batch_update_components))
        .route("/api/v1/components/{id}", put(component_api::update_component))
        .route("/api/v1/dictionaries", post(dictionary_api::create_dictionary))
        .route("/api/v1/dictionaries/{id}", put(dictionary_api::update_dictionary).delete(dictionary_api::delete_dictionary))
        .route("/api/v1/racks", post(rack_api::create_rack))
        .route("/api/v1/racks/{id}", put(rack_api::update_rack).delete(rack_api::delete_rack))
        .route("/api/v1/clients/{id}/hardware/pull", post(hardware_api::pull_hardware))
        .route_layer(middleware::from_fn(rbac::require_user));

    // Read routes (All authenticated)
    let read_routes = Router::new()
        .route("/api/v1/auth/me", get(auth_api::me))
        .route("/api/v1/auth/change-password", post(auth_api::change_password))
        .route("/api/v1/clients", get(client_api::list_clients))
        .route("/api/v1/clients/search", get(client_api::search_clients))
        .route("/api/v1/clients/filter_hardware", get(client_api::filter_clients_by_hardware))
        ...
        .route("/api/v1/dictionaries", get(dictionary_api::list_dictionaries))
        .route("/api/v1/dictionaries/{id}", get(dictionary_api::get_dictionary))
        .route("/api/v1/racks", get(rack_api::list_racks))
        .route("/api/v1/racks/{id}", get(rack_api::get_rack))
        .route("/api/v1/clients/{id}/hardware", get(hardware_api::get_hardware))
        .route("/api/v1/clients/{id}/hardware/history", get(hardware_api::get_hardware_history))
        .route("/api/v1/stats/hardware", get(stats_api::get_hardware_stats))
        .route("/api/v1/stats/clients", get(stats_api::get_clients_by_criteria))
        .route("/api/v1/stats/detailed", get(stats_api::get_detailed_stats))
        .route("/api/v1/stats/export", get(stats_api::export_client_hardware_data))
        .route("/api/v1/clients/filter", post(stats_api::filter_clients))
        .route("/api/v1/filter_options", get(stats_api::get_filter_options))
        .route("/api/v1/filter_options_by_ids", get(client_api::get_filter_options_by_client_ids));
