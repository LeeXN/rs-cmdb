...
pub fn get_translations() -> HashMap<String, String> {
    ...
    translations.insert(
        ...
        "Must be at most {max} characters".to_string(),
    );
    translations.insert(
    ...
    translations.insert(
        ...
        "Value must be between {min} and {max}".to_string(),
    );
    ...
    translations.insert(
        "client.updated".to_string(),
        "Client updated successfully".to_string(),
    );
    translations.insert(
        "client.deleted".to_string(),
    ...
    translations.insert(
        ...
        "Client with this hostname already exists".to_string(),
    );

    // Component-specific messages
    translations.insert(
        "component.not_found".to_string(),
    ...
    translations.insert(
        "component.deleted".to_string(),
        "Component deleted successfully".to_string(),
    );
    translations.insert(
    ...
    translations.insert(
        "rack.created".to_string(),
        "Rack created successfully".to_string(),
    );
    translations.insert(
        "rack.updated".to_string(),
        "Rack updated successfully".to_string(),
    );
    translations.insert(
        "rack.deleted".to_string(),
        "Rack deleted successfully".to_string(),
    );
    translations.insert(
        "rack.capacity_exceeded".to_string(),
        "Rack capacity exceeded".to_string(),
    );
    ...
    translations.insert(
        ...
        "Invalid manager specified".to_string(),
    );
    ...
    translations.insert(
        "auth.permission_denied".to_string(),
