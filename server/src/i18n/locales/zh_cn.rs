...
pub fn get_translations() -> HashMap<String, String> {
    ...
    translations.insert("validation.required".to_string(), "此字段为必填项".to_string());
    translations.insert("validation.invalid_email".to_string(), "邮箱格式无效".to_string());
    translations.insert("validation.invalid_url".to_string(), "URL格式无效".to_string());
    translations.insert("validation.too_short".to_string(), "至少需要{min}个字符".to_string());
    translations.insert("validation.too_long".to_string(), "最多{max}个字符".to_string());
    translations.insert("validation.invalid_format".to_string(), "格式无效".to_string());
    translations.insert("validation.out_of_range".to_string(), "值必须在{min}和{max}之间".to_string());
    ...
    translations.insert("success.operation_complete".to_string(), "操作成功完成".to_string());
    ...
    translations.insert("error.internal_server".to_string(), "服务器内部错误".to_string());
    translations.insert("error.bad_request".to_string(), "无效请求".to_string());
    translations.insert("error.method_not_allowed".to_string(), "方法不允许".to_string());
    translations.insert("error.request_timeout".to_string(), "请求超时".to_string());
    translations.insert("error.too_many_requests".to_string(), "请求过多".to_string());
    ...
    translations.insert("client.invalid_id".to_string(), "无效的客户端ID".to_string());
    translations.insert("client.duplicate_hostname".to_string(), "此主机名的客户端已存在".to_string());
    ...
    translations.insert("component.invalid_type".to_string(), "无效的组件类型".to_string());
    ...
    translations.insert("rack.capacity_exceeded".to_string(), "机架容量超出".to_string());
    ...
    translations.insert("project.invalid_manager".to_string(), "指定的负责人无效".to_string());
    ...
    translations.insert("user.invalid_credentials".to_string(), "用户名或密码无效".to_string());
    translations.insert("user.username_exists".to_string(), "用户名已存在".to_string());
    ...
    translations.insert("auth.token_invalid".to_string(), "令牌无效或已过期".to_string());
    translations.insert("auth.permission_denied".to_string(), "权限拒绝".to_string());

    // Database messages
    translations.insert("db.connection_error".to_string(), "数据库连接错误".to_string());
    translations.insert("db.query_error".to_string(), "数据库查询错误".to_string());
    translations.insert("db.transaction_error".to_string(), "数据库事务错误".to_string());
